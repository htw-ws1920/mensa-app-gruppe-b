...
function getPosition(){
    if(navigator.geolocation){
        ...
        showError(error.PERMISSION_DENIED);
    }
}    
...
function showError(error) {             
    switch(error.code) {
        case error.PERMISSION_DENIED:
            x.innerHTML = "Der Zugriff auf deinen Standort wurde abgelehnt."
            break;
        case error.POSITION_UNAVAILABLE:
            x.innerHTML = "Standortinformationen sind momentan nicht verfügbar."
            break;
        case error.TIMEOUT:
            x.innerHTML = "Die Anforderung zum Abrufen deines Standorts ist abgelaufen."
            break;
